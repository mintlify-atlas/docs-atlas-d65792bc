...
description: "Unleashed Recompiled is an unofficial PC port of Sonic Unleashed for Xbox 360, built via static recompilation for native performance on Windows and Linux."
---
