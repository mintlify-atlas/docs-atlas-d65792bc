---
title: "Build Unleashed Recompiled on macOS"
sidebarTitle: "macOS"
description: "Build Unleashed Recompiled on macOS with Xcode 16.3+ or Command Line Tools, CMake, and Ninja via Homebrew or MacPorts."
---
...
<Steps>
  ...
  <Step title="Run the game">
    The build produces a macOS app bundle. Open it with:

    ```bash
    open -a "Unleashed Recompiled.app" --args ./out/build/macos-release/UnleashedRecomp
    ```

    Or navigate to `./out/build/macos-release/UnleashedRecomp/` and double-click **Unleashed Recompiled.app** in Finder.
